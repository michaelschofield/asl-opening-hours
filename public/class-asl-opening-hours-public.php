...
class ASL_Opening_Hours_Public {
	...
	public function enqueue_unique_styles() {
		if (!is_admin()) {
		    wp_register_style( 'asl-opening-hours-stylesheet', '//sherman.library.nova.edu/cdn/styles/css/public-global/s--apa.css', array( 'pls-stylesheet' ), '1.1', 'all' );
		    wp_enqueue_style( 'asl-opening-hours-stylesheet' );
		}
	}

	public function enqueue_unique_scripts() {
		if (!is_admin()) {
		    wp_register_script( 'asl-opening-hours-script', plugins_url( 'asl-opening-hours/public/scripts/asl-opening-hours-scripts.js' ), array( 'pls-js' ), '0.1', true );
		    wp_enqueue_script( 'asl-opening-hours-script' );

		    wp_localize_script( 'asl-opening-hours-script', 'asl_Opening_Hours_search', array(
	...
	public function asl_Opening_Hours_search_fetch_results() {
